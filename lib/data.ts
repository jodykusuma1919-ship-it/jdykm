...
export const auctions: Auction[] = [
  {
    ...
    bids: [
      { user: 'Valdris', icon: '🧙', dkp: 980, time: 'HIGHEST' },
      { user: 'Thorgur', icon: '⚔', dkp: 950, time: '1m ago' },
      { user: 'Karath', icon: '🛡', dkp: 920, time: '2m ago' },
      { user: 'Selara', icon: '🧝', dkp: 890, time: '3m ago' },
      { user: 'Miravel', icon: '🧙', dkp: 860, time: '4m ago' },
      { user: 'Lyrath', icon: '🏹', dkp: 830, time: '5m ago' },
      { user: 'Daerith', icon: '⚔', dkp: 800, time: '6m ago' },
      { user: 'Korrath', icon: '🛡', dkp: 770, time: '7m ago' },
      { user: 'Varessa', icon: '✨', dkp: 740, time: '8m ago' },
      { user: 'Aelindra', icon: '🔮', dkp: 710, time: '9m ago' },
      { user: 'Braxus', icon: '⚔', dkp: 680, time: '10m ago' },
      { user: 'Cyndra', icon: '🧙', dkp: 650, time: '11m ago' },
      { user: 'Duriel', icon: '🛡', dkp: 620, time: '12m ago' },
      { user: 'Elara', icon: '✨', dkp: 590, time: '13m ago' },
      { user: 'Farath', icon: '⚔', dkp: 560, time: '14m ago' },
      { user: 'Gwendal', icon: '🏹', dkp: 530, time: '15m ago' },
      { user: 'Halion', icon: '🔮', dkp: 500, time: '16m ago' },
      { user: 'Ilnora', icon: '🧙', dkp: 470, time: '17m ago' },
      { user: 'Jaxar', icon: '⚔', dkp: 440, time: '18m ago' },
      { user: 'Kaelis', icon: '🛡', dkp: 410, time: '19m ago' },
      { user: 'Lerath', icon: '🏹', dkp: 380, time: '20m ago' },
      { user: 'Marek', icon: '⚔', dkp: 350, time: '21m ago' },
      { user: 'Noreth', icon: '🧙', dkp: 320, time: '22m ago' },
      { user: 'Ophara', icon: '✨', dkp: 290, time: '23m ago' },
      { user: 'Pyraxis', icon: '🔮', dkp: 260, time: '24m ago' },
      { user: 'Quentel', icon: '🛡', dkp: 230, time: '25m ago' },
      { user: 'Rhaena', icon: '🧝', dkp: 200, time: '26m ago' },
      { user: 'Syveth', icon: '⚔', dkp: 180, time: '27m ago' },
      { user: 'Talon', icon: '🏹', dkp: 160, time: '28m ago' },
      { user: 'Ulvar', icon: '🛡', dkp: 140, time: '29m ago' },
      { user: 'Vesper', icon: '✨', dkp: 130, time: '30m ago' },
      { user: 'Wrath', icon: '⚔', dkp: 120, time: '31m ago' },
      { user: 'Xyvara', icon: '🔮', dkp: 110, time: '32m ago' },
      { user: 'Ysgard', icon: '🛡', dkp: 100, time: '33m ago' },
      { user: 'Zephyr', icon: '🏹', dkp: 95, time: '34m ago' },
      { user: 'Aldric', icon: '⚔', dkp: 90, time: '35m ago' },
      { user: 'Bael', icon: '🧙', dkp: 85, time: '36m ago' },
      { user: 'Caer', icon: '🛡', dkp: 80, time: '37m ago' },
      { user: 'Dusk', icon: '🔮', dkp: 75, time: '38m ago' },
      { user: 'Elar', icon: '✨', dkp: 70, time: '39m ago' },
      { user: 'Fynd', icon: '⚔', dkp: 65, time: '40m ago' },
      { user: 'Gael', icon: '🏹', dkp: 60, time: '41m ago' },
      { user: 'Hort', icon: '🛡', dkp: 55, time: '42m ago' },
      { user: 'Ivan', icon: '🧙', dkp: 50, time: '43m ago' },
      { user: 'Jaxx', icon: '⚔', dkp: 45, time: '44m ago' },
      { user: 'Kira', icon: '✨', dkp: 40, time: '45m ago' },
      { user: 'Lorn', icon: '🔮', dkp: 35, time: '46m ago' },
      { user: 'Mira', icon: '🧝', dkp: 30, time: '47m ago' },
      { user: 'Nyx', icon: '🏹', dkp: 25, time: '48m ago' },
      { user: 'Orin', icon: '🛡', dkp: 20, time: '49m ago' },
    ],
    timeRemaining: 754,
  },
  {
    ...
    category: 'lnd',
    bids: [
      { user: 'Selara', icon: '🧝', dkp: 920, time: 'HIGHEST' },
      { user: 'Miravel', icon: '🧙', dkp: 880, time: '1m ago' },
      { user: 'Thorgur', icon: '⚔', dkp: 850, time: '2m ago' },
      { user: 'Karath', icon: '🛡', dkp: 820, time: '3m ago' },
      { user: 'Valdris', icon: '🧙', dkp: 790, time: '4m ago' },
      { user: 'Lyrath', icon: '🏹', dkp: 760, time: '5m ago' },
      { user: 'Daerith', icon: '⚔', dkp: 730, time: '6m ago' },
      { user: 'Korrath', icon: '🛡', dkp: 700, time: '7m ago' },
      { user: 'Varessa', icon: '✨', dkp: 670, time: '8m ago' },
      { user: 'Aelindra', icon: '🔮', dkp: 640, time: '9m ago' },
      { user: 'Braxus', icon: '⚔', dkp: 610, time: '10m ago' },
      { user: 'Cyndra', icon: '🧙', dkp: 580, time: '11m ago' },
      { user: 'Duriel', icon: '🛡', dkp: 550, time: '12m ago' },
      { user: 'Elara', icon: '✨', dkp: 520, time: '13m ago' },
      { user: 'Farath', icon: '⚔', dkp: 490, time: '14m ago' },
      { user: 'Gwendal', icon: '🏹', dkp: 460, time: '15m ago' },
      { user: 'Halion', icon: '🔮', dkp: 430, time: '16m ago' },
      { user: 'Ilnora', icon: '🧙', dkp: 400, time: '17m ago' },
      { user: 'Jaxar', icon: '⚔', dkp: 370, time: '18m ago' },
      { user: 'Kaelis', icon: '🛡', dkp: 340, time: '19m ago' },
      { user: 'Lerath', icon: '🏹', dkp: 310, time: '20m ago' },
      { user: 'Marek', icon: '⚔', dkp: 280, time: '21m ago' },
      { user: 'Noreth', icon: '🧙', dkp: 250, time: '22m ago' },
      { user: 'Ophara', icon: '✨', dkp: 220, time: '23m ago' },
      { user: 'Pyraxis', icon: '🔮', dkp: 190, time: '24m ago' },
      { user: 'Quentel', icon: '🛡', dkp: 170, time: '25m ago' },
      { user: 'Rhaena', icon: '🧝', dkp: 150, time: '26m ago' },
      { user: 'Syveth', icon: '⚔', dkp: 140, time: '27m ago' },
      { user: 'Talon', icon: '🏹', dkp: 130, time: '28m ago' },
      { user: 'Ulvar', icon: '🛡', dkp: 120, time: '29m ago' },
      { user: 'Vesper', icon: '✨', dkp: 110, time: '30m ago' },
      { user: 'Wrath', icon: '⚔', dkp: 100, time: '31m ago' },
      { user: 'Xyvara', icon: '🔮', dkp: 95, time: '32m ago' },
      { user: 'Ysgard', icon: '🛡', dkp: 90, time: '33m ago' },
      { user: 'Zephyr', icon: '🏹', dkp: 85, time: '34m ago' },
      { user: 'Aldric', icon: '⚔', dkp: 80, time: '35m ago' },
      { user: 'Bael', icon: '🧙', dkp: 75, time: '36m ago' },
      { user: 'Caer', icon: '🛡', dkp: 70, time: '37m ago' },
      { user: 'Dusk', icon: '🔮', dkp: 65, time: '38m ago' },
      { user: 'Elar', icon: '✨', dkp: 60, time: '39m ago' },
      { user: 'Fynd', icon: '⚔', dkp: 55, time: '40m ago' },
      { user: 'Gael', icon: '🏹', dkp: 50, time: '41m ago' },
      { user: 'Hort', icon: '🛡', dkp: 45, time: '42m ago' },
      { user: 'Ivan', icon: '🧙', dkp: 40, time: '43m ago' },
      { user: 'Jaxx', icon: '⚔', dkp: 35, time: '44m ago' },
      { user: 'Kira', icon: '✨', dkp: 30, time: '45m ago' },
      { user: 'Lorn', icon: '🔮', dkp: 28, time: '46m ago' },
      { user: 'Mira', icon: '🧝', dkp: 26, time: '47m ago' },
      { user: 'Nyx', icon: '🏹', dkp: 24, time: '48m ago' },
      { user: 'Orin', icon: '🛡', dkp: 22, time: '49m ago' },
    ],
    timeRemaining: 492,
  },
  {
    ...
    category: 'timespace',
    bids: [
      { user: 'Thorgur', icon: '🛡', dkp: 910, time: 'HIGHEST' },
      { user: 'Daerith', icon: '⚔', dkp: 880, time: '1m ago' },
      { user: 'Lyrath', icon: '🏹', dkp: 850, time: '2m ago' },
      { user: 'Valdris', icon: '🧙', dkp: 820, time: '3m ago' },
      { user: 'Selara', icon: '🧝', dkp: 790, time: '4m ago' },
      { user: 'Miravel', icon: '🧙', dkp: 760, time: '5m ago' },
      { user: 'Karath', icon: '🛡', dkp: 730, time: '6m ago' },
      { user: 'Korrath', icon: '🛡', dkp: 700, time: '7m ago' },
      { user: 'Varessa', icon: '✨', dkp: 670, time: '8m ago' },
      { user: 'Aelindra', icon: '🔮', dkp: 640, time: '9m ago' },
      { user: 'Braxus', icon: '⚔', dkp: 610, time: '10m ago' },
